...
export default function Home() {
  ...
  return <main>
    ...
    <header className="site-header"><a className="brand" href="/"><span className="brand-symbol">CV</span><span>CLEAR VIEW<small>BIOLABS</small></span></a><nav><a href="/catalog">Catalog</a><a href="/account">Account</a><a href="/contact">Contact</a></nav><a className="cart-button" href="/catalog" aria-label="Open research catalog"><span>Research Order</span><b>→</b></a></header>
