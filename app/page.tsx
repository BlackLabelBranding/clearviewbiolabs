...
export default function Home() {
  ...
  return <main>
    ...
    <header className="site-header"><a className="brand" href="#top"><span className="brand-symbol">CV</span><span>CLEAR VIEW<small>BIOLABS</small></span></a><nav><a href="#catalog">Catalog</a><a href="/account">Account</a><a href="mailto:Marc@Clearviewbiolabs.com">Contact</a></nav><button className="cart-button" onClick={() => setCartOpen(true)} aria-label={`Open cart with ${count} items`}><span>Research Order</span><b>{count}</b></button></header>
